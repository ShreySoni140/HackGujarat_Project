...
char phone_number[]="+919664770164"; //enter country code in XX and Mobile number to whome you want to send SMS over YYYYYYYYYY
char phone_number1[]="+91YYYYYYYYYY";
...
void SendMessage1()
{
  ...
  delay(100);
  mySerial.println("AT+CMGS=\"+919664770164\"\r"); //enter country code in XX and Mobile number to whome you want to send SMS over YYYYYYYYYY
  delay(100);
...
void sendSMS1()
{
    ...
    {   mySerial.println("Your Family member has met with an Accident");// The SMS text you want to send
        mySerial.println("Find me Here:-");
         ...
         mySerial.println();
         mySerial.print("Link :-");
             //sprintf(str1,"http://maps.google.com/?q=22.600861,72.820455",longitude,latitude);
